...
interface CustomPathProps extends PathProps {
  className?: string;
}

interface VideoOffProps extends SvgProps {
  fill?: string;
}

const VideoOff: React.FC<VideoOffProps> = (props) => {
  return (
    <Svg viewBox="0 0 31 30" {...props}>
      ...
      <G clipPath="url(#a)">
        <Path
          {...(props as CustomPathProps)} // Se asigna como CustomPathProps
